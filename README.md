# Awesome Web Security [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 459,676 | 🐛 68 | 📅 2026-04-19 with stars
...
* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings/) ⭐ 77,301 | 🐛 26 | 🌐 Python | 📅 2026-04-22 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - XSS Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XSS%20Injection) ⭐ 77,301 | 🐛 26 | 🌐 Python | 📅 2026-04-22 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
* [AwesomeXSS](https://github.com/s0md3v/AwesomeXSS) ⭐ 5,103 | 🐛 0 | 🌐 JavaScript | 📅 2024-10-30 - Written by [@s0md3v](https://github.com/s0md3v).
* [H5SC](https://github.com/cure53/H5SC) ⭐ 2,949 | 🐛 2 | 🌐 JavaScript | 📅 2022-02-23 - Written by [@cure53](https://github.com/cure53).
* [XSS.png](https://github.com/LucaBongiorni/XSS.png) ⭐ 56 | 🐛 0 | 📅 2016-01-16 - Written by @jackmasa.
...
* [Prototype pollution attack in NodeJS application](https://github.com/HoLyVieR/prototype-pollution-nsec18/blob/master/paper/JavaScript_prototype_pollution_attack_in_NodeJS.pdf) ⭐ 536 | 🐛 1 | 🌐 JavaScript | 📅 2024-05-25 - Written by [@HoLyVieR](https://github.com/HoLyVieR).
...
* [PayloadsAllTheThings - CSV Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/CSV%20Injection) ⭐ 77,301 | 🐛 26 | 🌐 Python | 📅 2026-04-22 - Written by [@swisskyrepo](https://github.com/swisskyrepo).

<a name="sql-injection"></a>

### SQL Injection

* [PayloadsAllTheThings - SQL Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SQL%20Injection) ⭐ 77,301 | 🐛 26 | 🌐 Python | 📅 2026-04-22 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Command Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Command%20Injection) ⭐ 77,301 | 🐛 26 | 🌐 Python | 📅 2026-04-22 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
* [Potential command injection in resolv.rb](https://github.com/ruby/ruby/pull/1777) ⭐ 23,549 | 🐛 572 | 🌐 Ruby | 📅 2026-04-28 - Written by [@drigg3r](https://github.com/drigg3r).
...
* [PayloadsAllTheThings - XXE Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XXE%20Injection) ⭐ 77,301 | 🐛 26 | 🌐 Python | 📅 2026-04-22 - Written by various contributors.
...
* [PayloadsAllTheThings - CSRF Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/CSRF%20Injection) ⭐ 77,301 | 🐛 26 | 🌐 Python | 📅 2026-04-22 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Server-Side Request Forgery](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Server%20Side%20Request%20Forgery) ⭐ 77,301 | 🐛 26 | 🌐 Python | 📅 2026-04-22 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Web Cache Deception](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Web%20Cache%20Deception) ⭐ 77,301 | 🐛 26 | 🌐 Python | 📅 2026-04-22 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Open Redirect](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Open%20Redirect) ⭐ 77,301 | 🐛 26 | 🌐 Python | 📅 2026-04-22 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - SAML Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SAML%20Injection) ⭐ 77,301 | 🐛 26 | 🌐 Python | 📅 2026-04-22 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Upload Insecure Files](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Upload%20Insecure%20Files) ⭐ 77,301 | 🐛 26 | 🌐 Python | 📅 2026-04-22 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [Practical introduction to SSL/TLS](https://github.com/Hakky54/mutual-tls-ssl) ⭐ 633 | 🐛 0 | 🌐 Java | 📅 2026-04-14 - Written by [@Hakky54](https://github.com/Hakky54).
...
* [Any protection against dynamic module import?](https://github.com/w3c/webappsec-csp/issues/243) ⭐ 221 | 🐛 199 | 🌐 HTML | 📅 2026-04-21 - Written by [@shhnjk](https://twitter.com/@shhnjk).
...
* [Stealing CSRF tokens with CSS injection (without iFrames)](https://github.com/dxa4481/cssInjection) ⭐ 324 | 🐛 1 | 🌐 HTML | 📅 2018-02-07 - Written by [@dxa4481](https://github.com/dxa4481).
...
* [awesome-cve-poc](https://github.com/qazbnm456/awesome-cve-poc) ⭐ 3,500 | 🐛 2 | 📅 2022-01-04 - Curated list of CVE PoCs by [@qazbnm456](https://github.com/qazbnm456).
* [Some-PoC-oR-ExP](https://github.com/coffeehb/Some-PoC-oR-ExP) ⭐ 2,498 | 🐛 2 | 🌐 Python | 📅 2025-06-24 - 各种漏洞poc、Exp的收集或编写 by [@coffeehb](https://github.com/coffeehb).
...
* [uxss-db](https://github.com/Metnew/uxss-db) ⭐ 701 | 🐛 0 | 🌐 HTML | 📅 2021-01-23 - Collection of UXSS CVEs with PoCs by [@Metnew](https://github.com/Metnew).
...
* [Capture the Flag CheatSheet](https://github.com/uppusaikiran/awesome-ctf-cheatsheet) ⭐ 134 | 🐛 0 | 📅 2025-04-29 - Written by [@uppusaikiran](https://github.com/uppusaikiran).
...
* [prowler](https://github.com/Alfresco/prowler) ⭐ 13,687 | 🐛 216 | 🌐 Python | 📅 2026-04-27 - Tool for AWS security assessment, auditing and hardening by [@Alfresco](https://github.com/Alfresco).
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,715 | 🐛 8 | 🌐 Python | 📅 2026-04-23 - Automated All-in-One OS command injection and exploitation tool by [@commixproject](https://github.com/commixproject).
...
* [Photon](https://github.com/s0md3v/Photon) ⭐ 12,837 | 🐛 60 | 🌐 Python | 📅 2026-02-10 - Incredibly fast crawler designed for OSINT by [@s0md3v](https://github.com/s0md3v).
...
* [Social Mapper](https://github.com/SpiderLabs/social_mapper) ⭐ 4,015 | 🐛 47 | 🌐 Python | 📅 2022-02-25 - Social Media Enumeration & Correlation Tool by Jacob Wilkin(Greenwolf) by [@SpiderLabs](https://github.com/SpiderLabs).
* [Raccoon](https://github.com/evyatarmeged/Raccoon) ⭐ 3,543 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - High performance offensive security tool for reconnaissance and vulnerability scanning by [@evyatarmeged](https://github.com/evyatarmeged).
* [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,521 | 🐛 26 | 🌐 C# | 📅 2022-12-08 - FOCA (Fingerprinting Organizations with Collected Archives) is a tool used mainly to find metadata and hidden information in the documents its scans by [ElevenPaths](https://www.elevenpaths.com/index.html).
...
* [ReconDog](https://github.com/s0md3v/ReconDog) ⭐ 2,042 | 🐛 14 | 🌐 Python | 📅 2021-01-26 - Reconnaissance Swiss Army Knife by [@s0md3v](https://github.com/s0md3v).
* [tinfoleak](https://github.com/vaguileradiaz/tinfoleak) ⭐ 1,970 | 🐛 28 | 🌐 Python | 📅 2019-02-06 - The most complete open-source tool for Twitter intelligence analysis by [@vaguileradiaz](https://github.com/vaguileradiaz).
...
* [Sublist3r](https://github.com/aboul3la/Sublist3r) ⭐ 10,888 | 🐛 250 | 🌐 Python | 📅 2024-08-02 - Sublist3r is a multi-threaded sub-domain enumeration tool for penetration testers by [@aboul3la](https://github.com/aboul3la).
...
* [subDomainsBrute](https://github.com/lijiejie/subDomainsBrute) ⭐ 3,610 | 🐛 16 | 🌐 Python | 📅 2022-09-15 - A simple and fast sub domain brute tool for pentesters by [@lijiejie](https://github.com/lijiejie).
* [domain\_analyzer](https://github.com/eldraco/domain_analyzer) ⭐ 1,863 | 🐛 10 | 🌐 Python | 📅 2022-12-29 - Analyze the security of any domain by finding all the information possible by [@eldraco](https://github.com/eldraco).
...
* [EyeWitness](https://github.com/ChrisTruncer/EyeWitness) ⭐ 62 | 🐛 0 | 📅 2024-05-31 - EyeWitness is designed to take screenshots of websites, provide some server header info, and identify default credentials if possible by [@ChrisTruncer](https://github.com/ChrisTruncer).
...
* [FuzzDB](https://github.com/fuzzdb-project/fuzzdb) ⭐ 8,887 | 🐛 16 | 🌐 PHP | 📅 2023-11-10 - Dictionary of attack patterns and primitives for black-box application fault injection and resource discovery.
* [wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,476 | 🐛 108 | 🌐 Python | 📅 2026-01-21 - Web application bruteforcer by [@xmendez](https://github.com/xmendez).
* [fuzz.txt](https://github.com/Bo0oM/fuzz.txt) ⭐ 3,300 | 🐛 10 | 📅 2025-08-25 - Potentially dangerous files by [@Bo0oM](https://github.com/Bo0oM).
* [dirhunt](https://github.com/Nekmo/dirhunt) ⭐ 1,990 | 🐛 11 | 🌐 Python | 📅 2023-10-29 - Web crawler optimized for searching and analyzing the directory structure of a site by [@nekmo](https://github.com/Nekmo).
* [domato](https://github.com/google/domato) ⭐ 1,774 | 🐛 3 | 🌐 Python | 📅 2024-11-26 - DOM fuzzer by [@google](https://github.com/google).
* [IPObfuscator](https://github.com/OsandaMalith/IPObfuscator) ⭐ 145 | 🐛 1 | 🌐 C | 📅 2022-07-29 - Simple tool to convert the IP to a DWORD IP by [@OsandaMalith](https://github.com/OsandaMalith).
* [charsetinspect](https://github.com/hack-all-the-things/charsetinspect) ⭐ 28 | 🐛 0 | 🌐 Python | 📅 2016-06-23 - Script that inspects multi-byte character sets looking for characters with specific user-defined properties by [@hack-all-the-things](https://github.com/hack-all-the-things).
...
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 28,107 | 🐛 129 | 🌐 Go | 📅 2026-04-27 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use by [@projectdiscovery](https://github.com/projectdiscovery).
* [wpscan](https://github.com/wpscanteam/wpscan) ⭐ 9,555 | 🐛 38 | 🌐 Ruby | 📅 2026-04-25 - WPScan is a black box WordPress vulnerability scanner by [@wpscanteam](https://github.com/wpscanteam).
* [JoomlaScan](https://github.com/drego85/JoomlaScan) ⭐ 255 | 🐛 5 | 🌐 Python | 📅 2023-08-01 - Free software to find the components installed in Joomla CMS, built out of the ashes of Joomscan by [@drego85](https://github.com/drego85).
...
* [Astra](https://github.com/flipkart-incubator/astra) ⭐ 2,644 | 🐛 67 | 🌐 Python | 📅 2024-06-05 - Automated Security Testing For REST API's by [@flipkart-incubator](https://github.com/flipkart-incubator).
* [TIDoS-Framework](https://github.com/theInfectedDrake/TIDoS-Framework) ⭐ 1,855 | 🐛 16 | 🌐 Python | 📅 2023-04-19 - A comprehensive web application audit framework to cover up everything from Reconnaissance and OSINT to Vulnerability Analysis by [@\_tID](https://github.com/theInfectedDrake).
* [aws\_pwn](https://github.com/dagrz/aws_pwn) ⭐ 1,224 | 🐛 3 | 🌐 Python | 📅 2023-08-30 - A collection of AWS penetration testing junk by [@dagrz](https://github.com/dagrz).
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 14,913 | 🐛 90 | 🌐 Python | 📅 2025-04-26 - XSStrike is a program which can fuzz and bruteforce parameters for XSS. It can also detect and bypass WAFs by [@s0md3v](https://github.com/s0md3v).
* [beef](https://github.com/beefproject/beef) ⭐ 10,828 | 🐛 48 | 🌐 JavaScript | 📅 2026-04-24 - The Browser Exploitation Framework Project by [beefproject](https://beefproject.com).
* [xssor2](https://github.com/evilcos/xssor2) ⭐ 2,207 | 🐛 3 | 🌐 JavaScript | 📅 2021-12-12 - XSS'OR - Hack with JavaScript by [@evilcos](https://github.com/evilcos).
* [JShell](https://github.com/s0md3v/JShell) ⭐ 534 | 🐛 1 | 🌐 Python | 📅 2019-05-05 - Get a JavaScript shell with XSS by [@s0md3v](https://github.com/s0md3v).
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 37,159 | 🐛 60 | 🌐 Python | 📅 2026-04-24 - Automatic SQL injection and database takeover tool.

<a name="tools-template-injection"></a>

#### Template Injection

* [tplmap](https://github.com/epinna/tplmap) ⭐ 4,150 | 🐛 45 | 🌐 Python | 📅 2024-04-21 - Code and Server-Side Template Injection Detection and Exploitation Tool by [@epinna](https://github.com/epinna).

<a name="tools-xxe"></a>

#### XXE

* [dtd-finder](https://github.com/GoSecure/dtd-finder) ⭐ 655 | 🐛 1 | 🌐 Kotlin | 📅 2024-02-21 - List DTDs and generate XXE payloads using those local DTDs by [@GoSecure](https://github.com/GoSecure).

<a name="tools-csrf"></a>

#### Cross Site Request Forgery

* [XSRFProbe](https://github.com/0xInfection/XSRFProbe) ⭐ 1,289 | 🐛 6 | 🌐 Python | 📅 2026-04-20 - The Prime CSRF Audit & Exploitation Toolkit by [@0xInfection](https://github.com/0xinfection).
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 26,338 | 🐛 358 | 🌐 Go | 📅 2026-03-25 - Searches full repo history for secrets and keys by [@zricethezav](https://github.com/zricethezav).
* [LinkFinder](https://github.com/GerbenJavado/LinkFinder) ⭐ 4,333 | 🐛 53 | 🌐 Python | 📅 2024-04-13 - Python script that finds endpoints in JavaScript files by [@GerbenJavado](https://github.com/GerbenJavado).
* [CSS-Keylogging](https://github.com/maxchehab/CSS-Keylogging) ⭐ 3,243 | 🐛 0 | 🌐 CSS | 📅 2018-02-20 - Chrome extension and Express server that exploits keylogging abilities of CSS by [@maxchehab](https://github.com/maxchehab).
* [GitMiner](https://github.com/UnkL4b/GitMiner) ⭐ 2,150 | 🐛 13 | 🌐 Python | 📅 2025-11-05 - Tool for advanced mining for content on Github by [@UnkL4b](https://github.com/UnkL4b).
...
* [dvcs-ripper](https://github.com/kost/dvcs-ripper) ⭐ 1,772 | 🐛 11 | 🌐 Perl | 📅 2024-07-19 - Rip web accessible (distributed) version control systems: SVN/GIT/HG... by [@kost](https://github.com/kost).
...
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,117 | 🐛 2 | 🌐 JavaScript | 📅 2026-04-24 - Scanner detecting the use of JavaScript libraries with known vulnerabilities by [@RetireJS](https://github.com/RetireJS).
* [OpenRASP](https://github.com/baidu/openrasp) ⭐ 2,957 | 🐛 62 | 🌐 C++ | 📅 2025-10-02 - An open source RASP solution actively maintained by Baidu Inc. With context-aware detection algorithm the project achieved nearly no false positives. And less than 3% performance reduction is observed under heavy server load.
...
* [bXSS](https://github.com/LewisArdern/bXSS) ⭐ 569 | 🐛 20 | 🌐 JavaScript | 📅 2023-03-04 - bXSS is a simple Blind XSS application adapted from [cure53.de/m](https://cure53.de/m) by [@LewisArdern](https://github.com/LewisArdern).
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 16,928 | 🐛 1 | 🌐 JavaScript | 📅 2026-04-28 - DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG by [Cure53](https://cure53.de/).
* [js-xss](https://github.com/leizongmin/js-xss) ⭐ 5,314 | 🐛 70 | 🌐 HTML | 📅 2026-03-04 - Sanitize untrusted HTML (to prevent XSS) with a configuration specified by a Whitelist by [@leizongmin](https://github.com/leizongmin).
* [Acra](https://github.com/cossacklabs/acra) ⭐ 1,473 | 🐛 20 | 🌐 Go | 📅 2026-04-23 - Client-side encryption engine for SQL databases, with strong selective encryption, SQL injections prevention and intrusion detection by [@cossacklabs](https://www.cossacklabs.com/).
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 43,292 | 🐛 428 | 🌐 Python | 📅 2026-04-25 - Interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers by [@mitmproxy](https://github.com/mitmproxy).

<a name="tools-webshell"></a>

### Webshell

* [webshell](https://github.com/tennc/webshell) ⭐ 10,719 | 🐛 1 | 🌐 PHP | 📅 2024-12-24 - This is a webshell open source project by [@tennc](https://github.com/tennc).
* [Weevely](https://github.com/epinna/weevely3) ⭐ 3,515 | 🐛 17 | 🌐 Python | 📅 2025-10-01 - Weaponized web shell by [@epinna](https://github.com/epinna).
* [PhpSploit](https://github.com/nil0x42/phpsploit) ⭐ 2,465 | 🐛 27 | 🌐 Python | 📅 2024-05-06 - Full-featured C2 framework which silently persists on webserver via evil PHP oneliner by [@nil0x42](https://github.com/nil0x42).
* [reverse-shell](https://github.com/lukechilds/reverse-shell) ⭐ 2,036 | 🐛 1 | 🌐 Go | 📅 2026-02-18 - Reverse Shell as a Service by [@lukechilds](https://github.com/lukechilds).
* [nano](https://github.com/s0md3v/nano) ⭐ 448 | 🐛 2 | 🌐 PHP | 📅 2020-02-18 - Family of code golfed PHP shells by [@s0md3v](https://github.com/s0md3v).
* [Webshell-Sniper](https://github.com/WangYihang/Webshell-Sniper) ⭐ 424 | 🐛 0 | 🌐 Python | 📅 2021-05-29 - Manage your website via terminal by [@WangYihang](https://github.com/WangYihang).
* [Reverse-Shell-Manager](https://github.com/WangYihang/Reverse-Shell-Manager) ⭐ 246 | 🐛 0 | 🌐 Python | 📅 2023-07-05 - Reverse Shell Manager via Terminal [@WangYihang](https://github.com/WangYihang).

<a name="tools-disassembler"></a>

### Disassembler

* [radare2](https://github.com/radare/radare2) ⭐ 23,539 | 🐛 809 | 🌐 C | 📅 2026-04-27 - Unix-like reverse engineering framework and commandline tools by [@radare](https://github.com/radare).
* [plasma](https://github.com/plasma-disassembler/plasma) ⭐ 3,068 | 🐛 15 | 🌐 Python | 📅 2021-08-31 - Plasma is an interactive disassembler for x86/ARM/MIPS by [@plasma-disassembler](https://github.com/plasma-disassembler).
...
* [Singularity of Origin](https://github.com/nccgroup/singularity) ⭐ 1,286 | 🐛 15 | 🌐 JavaScript | 📅 2026-04-26 - It includes the necessary components to rebind the IP address of the attack server DNS name to the target machine's IP address and to serve attack payloads to exploit vulnerable software on the target machine by [@nccgroup](https://github.com/nccgroup)
* [Whonow DNS Server](https://github.com/brannondorsey/whonow) ⭐ 660 | 🐛 9 | 🌐 JavaScript | 📅 2021-12-17 - A malicious DNS server for executing DNS Rebinding attacks on the fly by [@brannondorsey](https://github.com/brannondorsey)
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 34,687 | 🐛 554 | 🌐 JavaScript | 📅 2026-04-27 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis - by [@GCHQ](https://github.com/gchq).
* [ctftool](https://github.com/taviso/ctftool) ⭐ 1,665 | 🐛 15 | 🌐 C | 📅 2021-09-17 - Interactive CTF Exploration Tool by [@taviso](https://github.com/taviso).
* [cefdebug](https://github.com/taviso/cefdebug) ⭐ 210 | 🐛 0 | 🌐 C | 📅 2020-06-10 - Minimal code to connect to a CEF debugger by [@taviso](https://github.com/taviso).
* [ntlm\_challenger](https://github.com/b17zr/ntlm_challenger) ⭐ 153 | 🐛 1 | 🌐 Python | 📅 2022-11-10 - Parse NTLM over HTTP challenge messages by [@b17zr](https://github.com/b17zr).
...
* [CloudGoat](https://github.com/RhinoSecurityLabs/cloudgoat) ⭐ 3,554 | 🐛 21 | 🌐 Python | 📅 2026-04-27 - Rhino Security Labs' "Vulnerable by Design" AWS infrastructure setup tool  - Written by [@RhinoSecurityLabs](https://github.com/RhinoSecurityLabs).
...
* [Infosec\_Reference](https://github.com/rmusser01/Infosec_Reference) ⭐ 5,938 | 🐛 0 | 🌐 CSS | 📅 2025-10-20 - Information Security Reference That Doesn't Suck by [@rmusser01](https://github.com/rmusser01).
* [awesome-bug-bounty](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,609 | 🐛 18 | 📅 2026-03-07 - Comprehensive curated list of available Bug Bounty & Disclosure Programs and write-ups by [@djadmin](https://github.com/djadmin).
...
* [bug-bounty-reference](https://github.com/ngalongc/bug-bounty-reference) ⭐ 4,178 | 🐛 3 | 📅 2024-07-31 - List of bug bounty write-up that is categorized by the bug nature by [@ngalongc](https://github.com/ngalongc).
