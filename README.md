# Awesome Web Security [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 446,761 | 🐛 84 | 📅 2026-03-09 with stars
...
* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings/) ⭐ 76,161 | 🐛 19 | 🌐 Python | 📅 2026-03-16 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - XSS Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XSS%20Injection) ⭐ 76,161 | 🐛 19 | 🌐 Python | 📅 2026-03-16 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
* [AwesomeXSS](https://github.com/s0md3v/AwesomeXSS) ⭐ 5,073 | 🐛 0 | 🌐 JavaScript | 📅 2024-10-30 - Written by [@s0md3v](https://github.com/s0md3v).
...
* [PayloadsAllTheThings - CSV Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/CSV%20Injection) ⭐ 76,161 | 🐛 19 | 🌐 Python | 📅 2026-03-16 - Written by [@swisskyrepo](https://github.com/swisskyrepo).

<a name="sql-injection"></a>

### SQL Injection

* [PayloadsAllTheThings - SQL Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SQL%20Injection) ⭐ 76,161 | 🐛 19 | 🌐 Python | 📅 2026-03-16 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Command Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Command%20Injection) ⭐ 76,161 | 🐛 19 | 🌐 Python | 📅 2026-03-16 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
* [Potential command injection in resolv.rb](https://github.com/ruby/ruby/pull/1777) ⭐ 23,519 | 🐛 578 | 🌐 Ruby | 📅 2026-03-19 - Written by [@drigg3r](https://github.com/drigg3r).
...
* [PayloadsAllTheThings - XXE Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XXE%20Injection) ⭐ 76,161 | 🐛 19 | 🌐 Python | 📅 2026-03-16 - Written by various contributors.
...
* [PayloadsAllTheThings - CSRF Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/CSRF%20Injection) ⭐ 76,161 | 🐛 19 | 🌐 Python | 📅 2026-03-16 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Server-Side Request Forgery](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Server%20Side%20Request%20Forgery) ⭐ 76,161 | 🐛 19 | 🌐 Python | 📅 2026-03-16 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Web Cache Deception](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Web%20Cache%20Deception) ⭐ 76,161 | 🐛 19 | 🌐 Python | 📅 2026-03-16 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Open Redirect](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Open%20Redirect) ⭐ 76,161 | 🐛 19 | 🌐 Python | 📅 2026-03-16 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - SAML Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SAML%20Injection) ⭐ 76,161 | 🐛 19 | 🌐 Python | 📅 2026-03-16 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Upload Insecure Files](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Upload%20Insecure%20Files) ⭐ 76,161 | 🐛 19 | 🌐 Python | 📅 2026-03-16 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [prowler](https://github.com/Alfresco/prowler) ⭐ 13,353 | 🐛 189 | 🌐 Python | 📅 2026-03-18 - Tool for AWS security assessment, auditing and hardening by [@Alfresco](https://github.com/Alfresco).
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,678 | 🐛 8 | 🌐 Python | 📅 2026-03-16 - Automated All-in-One OS command injection and exploitation tool by [@commixproject](https://github.com/commixproject).
...
* [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,455 | 🐛 25 | 🌐 C# | 📅 2022-12-08 - FOCA (Fingerprinting Organizations with Collected Archives) is a tool used mainly to find metadata and hidden information in the documents its scans by [ElevenPaths](https://www.elevenpaths.com/index.html).
...
* [ReconDog](https://github.com/s0md3v/ReconDog) ⭐ 2,021 | 🐛 14 | 🌐 Python | 📅 2021-01-26 - Reconnaissance Swiss Army Knife by [@s0md3v](https://github.com/s0md3v).
...
* [Sublist3r](https://github.com/aboul3la/Sublist3r) ⭐ 10,860 | 🐛 249 | 🌐 Python | 📅 2024-08-02 - Sublist3r is a multi-threaded sub-domain enumeration tool for penetration testers by [@aboul3la](https://github.com/aboul3la).
...
* [FuzzDB](https://github.com/fuzzdb-project/fuzzdb) ⭐ 8,851 | 🐛 16 | 🌐 PHP | 📅 2023-11-10 - Dictionary of attack patterns and primitives for black-box application fault injection and resource discovery.
* [wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,445 | 🐛 108 | 🌐 Python | 📅 2026-01-21 - Web application bruteforcer by [@xmendez](https://github.com/xmendez).
...
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 27,526 | 🐛 355 | 🌐 Go | 📅 2026-03-17 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use by [@projectdiscovery](https://github.com/projectdiscovery).
...
* [Astra](https://github.com/flipkart-incubator/astra) ⭐ 2,643 | 🐛 67 | 🌐 Python | 📅 2024-06-05 - Automated Security Testing For REST API's by [@flipkart-incubator](https://github.com/flipkart-incubator).
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 14,825 | 🐛 87 | 🌐 Python | 📅 2025-04-26 - XSStrike is a program which can fuzz and bruteforce parameters for XSS. It can also detect and bypass WAFs by [@s0md3v](https://github.com/s0md3v).
* [beef](https://github.com/beefproject/beef) ⭐ 10,775 | 🐛 43 | 🌐 JavaScript | 📅 2026-03-16 - The Browser Exploitation Framework Project by [beefproject](https://beefproject.com).
* [xssor2](https://github.com/evilcos/xssor2) ⭐ 2,205 | 🐛 3 | 🌐 JavaScript | 📅 2021-12-12 - XSS'OR - Hack with JavaScript by [@evilcos](https://github.com/evilcos).
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 36,861 | 🐛 61 | 🌐 Python | 📅 2026-03-18 - Automatic SQL injection and database takeover tool.

<a name="tools-template-injection"></a>

#### Template Injection

* [tplmap](https://github.com/epinna/tplmap) ⭐ 4,128 | 🐛 45 | 🌐 Python | 📅 2024-04-21 - Code and Server-Side Template Injection Detection and Exploitation Tool by [@epinna](https://github.com/epinna).
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 25,473 | 🐛 350 | 🌐 Go | 📅 2026-03-12 - Searches full repo history for secrets and keys by [@zricethezav](https://github.com/zricethezav).
* [LinkFinder](https://github.com/GerbenJavado/LinkFinder) ⭐ 4,303 | 🐛 52 | 🌐 Python | 📅 2024-04-13 - Python script that finds endpoints in JavaScript files by [@GerbenJavado](https://github.com/GerbenJavado).
...
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,090 | 🐛 3 | 🌐 JavaScript | 📅 2026-03-18 - Scanner detecting the use of JavaScript libraries with known vulnerabilities by [@RetireJS](https://github.com/RetireJS).
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 16,762 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-14 - DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG by [Cure53](https://cure53.de/).
* [js-xss](https://github.com/leizongmin/js-xss) ⭐ 5,307 | 🐛 70 | 🌐 HTML | 📅 2026-03-04 - Sanitize untrusted HTML (to prevent XSS) with a configuration specified by a Whitelist by [@leizongmin](https://github.com/leizongmin).
* [Acra](https://github.com/cossacklabs/acra) ⭐ 1,458 | 🐛 19 | 🌐 Go | 📅 2026-03-18 - Client-side encryption engine for SQL databases, with strong selective encryption, SQL injections prevention and intrusion detection by [@cossacklabs](https://www.cossacklabs.com/).
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 42,710 | 🐛 420 | 🌐 Python | 📅 2026-03-18 - Interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers by [@mitmproxy](https://github.com/mitmproxy).
...
* [Weevely](https://github.com/epinna/weevely3) ⭐ 3,497 | 🐛 17 | 🌐 Python | 📅 2025-10-01 - Weaponized web shell by [@epinna](https://github.com/epinna).
...
* [Reverse-Shell-Manager](https://github.com/WangYihang/Reverse-Shell-Manager) ⭐ 245 | 🐛 0 | 🌐 Python | 📅 2023-07-05 - Reverse Shell Manager via Terminal [@WangYihang](https://github.com/WangYihang).

<a name="tools-disassembler"></a>

### Disassembler

* [radare2](https://github.com/radare/radare2) ⭐ 23,260 | 🐛 843 | 🌐 C | 📅 2026-03-19 - Unix-like reverse engineering framework and commandline tools by [@radare](https://github.com/radare).
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 34,342 | 🐛 571 | 🌐 JavaScript | 📅 2026-03-15 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis - by [@GCHQ](https://github.com/gchq).
...
* [CloudGoat](https://github.com/RhinoSecurityLabs/cloudgoat) ⭐ 3,509 | 🐛 20 | 🌐 Python | 📅 2026-03-17 - Rhino Security Labs' "Vulnerable by Design" AWS infrastructure setup tool  - Written by [@RhinoSecurityLabs](https://github.com/RhinoSecurityLabs).
...
* [awesome-bug-bounty](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,505 | 🐛 15 | 📅 2026-03-07 - Comprehensive curated list of available Bug Bounty & Disclosure Programs and write-ups by [@djadmin](https://github.com/djadmin).
