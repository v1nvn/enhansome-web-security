# Awesome Web Security [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 454,332 | 🐛 61 | 📅 2026-04-02 with stars
...
* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings/) ⭐ 76,817 | 🐛 22 | 🌐 Python | 📅 2026-04-08 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - XSS Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XSS%20Injection) ⭐ 76,817 | 🐛 22 | 🌐 Python | 📅 2026-04-08 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
* [AwesomeXSS](https://github.com/s0md3v/AwesomeXSS) ⭐ 5,097 | 🐛 0 | 🌐 JavaScript | 📅 2024-10-30 - Written by [@s0md3v](https://github.com/s0md3v).
* [H5SC](https://github.com/cure53/H5SC) ⭐ 2,965 | 🐛 2 | 🌐 JavaScript | 📅 2022-02-23 - Written by [@cure53](https://github.com/cure53).
...
* [PayloadsAllTheThings - CSV Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/CSV%20Injection) ⭐ 76,817 | 🐛 22 | 🌐 Python | 📅 2026-04-08 - Written by [@swisskyrepo](https://github.com/swisskyrepo).

<a name="sql-injection"></a>

### SQL Injection

* [PayloadsAllTheThings - SQL Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SQL%20Injection) ⭐ 76,817 | 🐛 22 | 🌐 Python | 📅 2026-04-08 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Command Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Command%20Injection) ⭐ 76,817 | 🐛 22 | 🌐 Python | 📅 2026-04-08 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
* [Potential command injection in resolv.rb](https://github.com/ruby/ruby/pull/1777) ⭐ 23,504 | 🐛 570 | 🌐 Ruby | 📅 2026-04-12 - Written by [@drigg3r](https://github.com/drigg3r).
...
* [PayloadsAllTheThings - XXE Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XXE%20Injection) ⭐ 76,817 | 🐛 22 | 🌐 Python | 📅 2026-04-08 - Written by various contributors.
...
* [PayloadsAllTheThings - CSRF Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/CSRF%20Injection) ⭐ 76,817 | 🐛 22 | 🌐 Python | 📅 2026-04-08 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Server-Side Request Forgery](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Server%20Side%20Request%20Forgery) ⭐ 76,817 | 🐛 22 | 🌐 Python | 📅 2026-04-08 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Web Cache Deception](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Web%20Cache%20Deception) ⭐ 76,817 | 🐛 22 | 🌐 Python | 📅 2026-04-08 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Open Redirect](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Open%20Redirect) ⭐ 76,817 | 🐛 22 | 🌐 Python | 📅 2026-04-08 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - SAML Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SAML%20Injection) ⭐ 76,817 | 🐛 22 | 🌐 Python | 📅 2026-04-08 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Upload Insecure Files](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Upload%20Insecure%20Files) ⭐ 76,817 | 🐛 22 | 🌐 Python | 📅 2026-04-08 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [prowler](https://github.com/Alfresco/prowler) ⭐ 13,546 | 🐛 207 | 🌐 Python | 📅 2026-04-10 - Tool for AWS security assessment, auditing and hardening by [@Alfresco](https://github.com/Alfresco).
...
* [Photon](https://github.com/s0md3v/Photon) ⭐ 12,807 | 🐛 61 | 🌐 Python | 📅 2026-02-10 - Incredibly fast crawler designed for OSINT by [@s0md3v](https://github.com/s0md3v).
...
* [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,497 | 🐛 25 | 🌐 C# | 📅 2022-12-08 - FOCA (Fingerprinting Organizations with Collected Archives) is a tool used mainly to find metadata and hidden information in the documents its scans by [ElevenPaths](https://www.elevenpaths.com/index.html).
...
* [subDomainsBrute](https://github.com/lijiejie/subDomainsBrute) ⭐ 3,606 | 🐛 16 | 🌐 Python | 📅 2022-09-15 - A simple and fast sub domain brute tool for pentesters by [@lijiejie](https://github.com/lijiejie).
...
* [FuzzDB](https://github.com/fuzzdb-project/fuzzdb) ⭐ 8,871 | 🐛 16 | 🌐 PHP | 📅 2023-11-10 - Dictionary of attack patterns and primitives for black-box application fault injection and resource discovery.
* [wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,466 | 🐛 108 | 🌐 Python | 📅 2026-01-21 - Web application bruteforcer by [@xmendez](https://github.com/xmendez).
...
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 27,865 | 🐛 140 | 🌐 Go | 📅 2026-04-10 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use by [@projectdiscovery](https://github.com/projectdiscovery).
...
* [Astra](https://github.com/flipkart-incubator/astra) ⭐ 2,647 | 🐛 67 | 🌐 Python | 📅 2024-06-05 - Automated Security Testing For REST API's by [@flipkart-incubator](https://github.com/flipkart-incubator).
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 14,886 | 🐛 88 | 🌐 Python | 📅 2025-04-26 - XSStrike is a program which can fuzz and bruteforce parameters for XSS. It can also detect and bypass WAFs by [@s0md3v](https://github.com/s0md3v).
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 37,052 | 🐛 59 | 🌐 Python | 📅 2026-04-09 - Automatic SQL injection and database takeover tool.
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 25,898 | 🐛 356 | 🌐 Go | 📅 2026-03-25 - Searches full repo history for secrets and keys by [@zricethezav](https://github.com/zricethezav).
...
* [dvcs-ripper](https://github.com/kost/dvcs-ripper) ⭐ 1,773 | 🐛 11 | 🌐 Perl | 📅 2024-07-19 - Rip web accessible (distributed) version control systems: SVN/GIT/HG... by [@kost](https://github.com/kost).
...
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,107 | 🐛 4 | 🌐 JavaScript | 📅 2026-04-11 - Scanner detecting the use of JavaScript libraries with known vulnerabilities by [@RetireJS](https://github.com/RetireJS).
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 16,849 | 🐛 1 | 🌐 JavaScript | 📅 2026-04-11 - DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG by [Cure53](https://cure53.de/).
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 43,041 | 🐛 426 | 🌐 Python | 📅 2026-04-10 - Interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers by [@mitmproxy](https://github.com/mitmproxy).

<a name="tools-webshell"></a>

### Webshell

* [webshell](https://github.com/tennc/webshell) ⭐ 10,707 | 🐛 1 | 🌐 PHP | 📅 2024-12-24 - This is a webshell open source project by [@tennc](https://github.com/tennc).
...
* [radare2](https://github.com/radare/radare2) ⭐ 23,414 | 🐛 819 | 🌐 C | 📅 2026-04-11 - Unix-like reverse engineering framework and commandline tools by [@radare](https://github.com/radare).
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 34,544 | 🐛 573 | 🌐 JavaScript | 📅 2026-04-11 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis - by [@GCHQ](https://github.com/gchq).
...
* [CloudGoat](https://github.com/RhinoSecurityLabs/cloudgoat) ⭐ 3,537 | 🐛 19 | 🌐 Python | 📅 2026-04-10 - Rhino Security Labs' "Vulnerable by Design" AWS infrastructure setup tool  - Written by [@RhinoSecurityLabs](https://github.com/RhinoSecurityLabs).
...
* [awesome-bug-bounty](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,578 | 🐛 17 | 📅 2026-03-07 - Comprehensive curated list of available Bug Bounty & Disclosure Programs and write-ups by [@djadmin](https://github.com/djadmin).
