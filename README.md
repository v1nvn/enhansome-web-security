...
# Awesome Web Security [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 436,832 | 🐛 67 | 📅 2026-01-28 with stars
...
* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings/) ⭐ 75,129 | 🐛 14 | 🌐 Python | 📅 2026-02-02 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - XSS Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XSS%20Injection) ⭐ 75,129 | 🐛 14 | 🌐 Python | 📅 2026-02-02 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
* [AwesomeXSS](https://github.com/s0md3v/AwesomeXSS) ⭐ 5,055 | 🐛 0 | 🌐 JavaScript | 📅 2024-10-30 - Written by [@s0md3v](https://github.com/s0md3v).
...
* [PayloadsAllTheThings - CSV Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/CSV%20Injection) ⭐ 75,129 | 🐛 14 | 🌐 Python | 📅 2026-02-02 - Written by [@swisskyrepo](https://github.com/swisskyrepo).

<a name="sql-injection"></a>

### SQL Injection

* [PayloadsAllTheThings - SQL Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SQL%20Injection) ⭐ 75,129 | 🐛 14 | 🌐 Python | 📅 2026-02-02 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Command Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Command%20Injection) ⭐ 75,129 | 🐛 14 | 🌐 Python | 📅 2026-02-02 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
* [Potential command injection in resolv.rb](https://github.com/ruby/ruby/pull/1777) ⭐ 23,306 | 🐛 556 | 🌐 Ruby | 📅 2026-02-12 - Written by [@drigg3r](https://github.com/drigg3r).
...
* [PayloadsAllTheThings - XXE Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XXE%20Injection) ⭐ 75,129 | 🐛 14 | 🌐 Python | 📅 2026-02-02 - Written by various contributors.
...
* [PayloadsAllTheThings - CSRF Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/CSRF%20Injection) ⭐ 75,129 | 🐛 14 | 🌐 Python | 📅 2026-02-02 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Server-Side Request Forgery](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Server%20Side%20Request%20Forgery) ⭐ 75,129 | 🐛 14 | 🌐 Python | 📅 2026-02-02 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Web Cache Deception](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Web%20Cache%20Deception) ⭐ 75,129 | 🐛 14 | 🌐 Python | 📅 2026-02-02 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Open Redirect](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Open%20Redirect) ⭐ 75,129 | 🐛 14 | 🌐 Python | 📅 2026-02-02 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - SAML Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SAML%20Injection) ⭐ 75,129 | 🐛 14 | 🌐 Python | 📅 2026-02-02 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Upload Insecure Files](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Upload%20Insecure%20Files) ⭐ 75,129 | 🐛 14 | 🌐 Python | 📅 2026-02-02 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [prowler](https://github.com/Alfresco/prowler) ⭐ 12,972 | 🐛 222 | 🌐 Python | 📅 2026-02-11 - Tool for AWS security assessment, auditing and hardening by [@Alfresco](https://github.com/Alfresco).
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,625 | 🐛 8 | 🌐 Python | 📅 2026-02-08 - Automated All-in-One OS command injection and exploitation tool by [@commixproject](https://github.com/commixproject).
...
* [Photon](https://github.com/s0md3v/Photon) ⭐ 12,665 | 🐛 59 | 🌐 Python | 📅 2026-02-10 - Incredibly fast crawler designed for OSINT by [@s0md3v](https://github.com/s0md3v).
...
* [Sublist3r](https://github.com/aboul3la/Sublist3r) ⭐ 10,806 | 🐛 248 | 🌐 Python | 📅 2024-08-02 - Sublist3r is a multi-threaded sub-domain enumeration tool for penetration testers by [@aboul3la](https://github.com/aboul3la).
...
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 26,980 | 🐛 224 | 🌐 Go | 📅 2026-02-11 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use by [@projectdiscovery](https://github.com/projectdiscovery).
* [wpscan](https://github.com/wpscanteam/wpscan) ⭐ 9,450 | 🐛 72 | 🌐 Ruby | 📅 2026-02-09 - WPScan is a black box WordPress vulnerability scanner by [@wpscanteam](https://github.com/wpscanteam).
...
* [TIDoS-Framework](https://github.com/theInfectedDrake/TIDoS-Framework) ⭐ 1,852 | 🐛 16 | 🌐 Python | 📅 2023-04-19 - A comprehensive web application audit framework to cover up everything from Reconnaissance and OSINT to Vulnerability Analysis by [@\_tID](https://github.com/theInfectedDrake).
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 14,731 | 🐛 86 | 🌐 Python | 📅 2025-04-26 - XSStrike is a program which can fuzz and bruteforce parameters for XSS. It can also detect and bypass WAFs by [@s0md3v](https://github.com/s0md3v).
* [beef](https://github.com/beefproject/beef) ⭐ 10,721 | 🐛 42 | 🌐 JavaScript | 📅 2026-02-10 - The Browser Exploitation Framework Project by [beefproject](https://beefproject.com).
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 36,584 | 🐛 57 | 🌐 Python | 📅 2026-02-05 - Automatic SQL injection and database takeover tool.

<a name="tools-template-injection"></a>

#### Template Injection

* [tplmap](https://github.com/epinna/tplmap) ⭐ 4,117 | 🐛 45 | 🌐 Python | 📅 2024-04-21 - Code and Server-Side Template Injection Detection and Exploitation Tool by [@epinna](https://github.com/epinna).
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 24,875 | 🐛 345 | 🌐 Go | 📅 2026-01-08 - Searches full repo history for secrets and keys by [@zricethezav](https://github.com/zricethezav).
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 16,609 | 🐛 1 | 🌐 JavaScript | 📅 2026-02-07 - DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG by [Cure53](https://cure53.de/).
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 42,265 | 🐛 407 | 🌐 Python | 📅 2026-02-11 - Interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers by [@mitmproxy](https://github.com/mitmproxy).

<a name="tools-webshell"></a>

### Webshell

* [webshell](https://github.com/tennc/webshell) ⭐ 10,684 | 🐛 1 | 🌐 PHP | 📅 2024-12-24 - This is a webshell open source project by [@tennc](https://github.com/tennc).
...
* [reverse-shell](https://github.com/lukechilds/reverse-shell) ⭐ 1,956 | 🐛 15 | 🌐 Go | 📅 2026-02-11 - Reverse Shell as a Service by [@lukechilds](https://github.com/lukechilds).
...
* [radare2](https://github.com/radare/radare2) ⭐ 23,079 | 🐛 836 | 🌐 C | 📅 2026-02-12 - Unix-like reverse engineering framework and commandline tools by [@radare](https://github.com/radare).
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 34,023 | 🐛 561 | 🌐 JavaScript | 📅 2026-02-11 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis - by [@GCHQ](https://github.com/gchq).
...
* [CloudGoat](https://github.com/RhinoSecurityLabs/cloudgoat) ⭐ 3,473 | 🐛 41 | 🌐 Python | 📅 2026-01-24 - Rhino Security Labs' "Vulnerable by Design" AWS infrastructure setup tool  - Written by [@RhinoSecurityLabs](https://github.com/RhinoSecurityLabs).
...
* [awesome-bug-bounty](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,405 | 🐛 18 | 📅 2024-01-15 - Comprehensive curated list of available Bug Bounty & Disclosure Programs and write-ups by [@djadmin](https://github.com/djadmin).
